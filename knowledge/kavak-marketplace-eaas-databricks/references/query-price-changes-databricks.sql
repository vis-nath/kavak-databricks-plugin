-- queries/price_changes_databricks.sql
-- Historial de precios (LOG) para stocks actualmente publicados.
-- Versión Databricks de price_changes.sql.
-- {stock_ids} se reemplaza en Python con lista de IDs (enteros).
--
-- Cambios vs Redshift:
...
SELECT
    ...
    DATE(po.updated_date)                                            AS fecha_actualizacion
